...
export class HomePage {
  ...
  saveDoc(imgtext)
  {
    ...
    var today = dd + '/' + mm;
    var datetime = 'OCR-NewDoc-'+today +'/'+ currentdate.getFullYear() + '-'+ currentdate.getHours() + ':'
  ...
  pdfMake()
  {
    ...
    var docDefinition = {
      ...
      pdfmake.createPdf(docDefinition).getBuffer(function (buffer) {
        ...
        var mm = String(currentdate.getMonth() + 1).padStart(2, '0'); //January is 0!
        var today = dd + '/' + mm;
        var file = 'OCR-'+ today +'/'+ currentdate.getFullYear() + '-'+ currentdate.getHours() + ':'
        + currentdate.getMinutes() + ':' + currentdate.getSeconds();;
        self.saveToDevice(binaryArray,file+".pdf")
        });
